...
FALSE.  The quote argument was also set so that only double quotes,
not single quotes, would be used to mark strings containing a comma,
since some gene annotations contain the single quote for indicating
3-prime or 5-prime.
