...
> You can also use a tool like https://www.w3schools.com/colors/colors_picker.asp
...
Anyway, now we can make a plot like this one to compare each gene across two samples.
...
format, I could do the opposite operation.
